...
Do you want to play again? (yes/no)
```
NOTE: '>' denotes the input.  
NOTE: <i>hangman-ascii.txt</i> contains the complete example.  
NOTE: You can find ASCII drawings in the example file and copy it if you do not want to spend time on drawing or searching web.  
